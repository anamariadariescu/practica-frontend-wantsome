...
const User = new Person("Saian", "Patris");

console.log(User.displayPersonName());
...
let elephants = new Elephant('Nor', '15');
...
const bankAccount = new Account('Ana', 'Iasi');
const transaction1 = new Transaction('Sandra', 'ing', 100, 'baniDeVacanta');
const transaction2 = new Transaction('Andrei', 'ing', 50, 'pizza');
